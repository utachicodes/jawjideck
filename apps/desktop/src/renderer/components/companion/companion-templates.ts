...
export const COMPANION_TEMPLATES: CompanionTemplate[] = [
  ...
  // ── Raspberry Pi Templates ───────────────────────────────────
  {
    ...
    category: 'Telemetry',
    flashMethod: 'image',
    installCommand: 'curl -fsSL https://raw.githubusercontent.com/utachicodes/jawjideck/master/packages/companion-scripts/pi-telemetry.sh | sudo bash',
    features: ['mavlink-router daemon', 'WiFi access point (NetworkManager)', 'Multiple GCS connections', 'Jawji Agent pre-installed', 'Auto-start on boot'],
  ...
  },
  {
    ...
    category: 'Autonomy',
    flashMethod: 'image',
    installCommand: 'curl -fsSL https://raw.githubusercontent.com/utachicodes/jawjideck/master/packages/companion-scripts/pi-autonomy.sh | sudo bash',
    features: ['MAVSDK Python venv', 'MAVLink routing', 'Mission script examples', 'Jawji Agent', 'mavlink-router + agent auto-start on boot (mission scripts run manually, by design)'],
  ...
  // ── Jetson Templates ─────────────────────────────────────────
  {
    ...
    category: 'Autonomy',
    flashMethod: 'script',
    installCommand: 'curl -fsSL https://raw.githubusercontent.com/utachicodes/jawjideck/master/packages/companion-scripts/jetson-cv.sh | sudo bash',
    features: ['YOLO object detection (GPU, Ultralytics)', 'MAVSDK integration', 'MAVLink routing', 'Camera pipeline example', 'Jawji Agent', 'ROS2 optional (not automated)'],
