...
export const COMPANION_TEMPLATES: CompanionTemplate[] = [
  ...
  // ── Raspberry Pi Templates ───────────────────────────────────
  {
    ...
    category: 'Telemetry',
    flashMethod: 'image',
    installCommand: 'curl -fsSL https://jawji.space/companion/pi-telemetry.sh | bash',
    features: ['mavlink-router daemon', 'WiFi access point', 'Multiple GCS connections', 'Jawji Agent pre-installed', 'Auto-start on boot'],
  ...
  },
  {
    ...
    category: 'Video',
    flashMethod: 'image',
    installCommand: 'curl -fsSL https://jawji.space/companion/pi-video.sh | bash',
    features: ['Pi Camera H.264 streaming', 'GStreamer RTSP/UDP pipeline', 'MAVLink routing', 'WiFi AP', 'Jawji Agent', 'Web preview'],
  ...
  },
  {
    ...
    category: 'Autonomy',
    flashMethod: 'image',
    installCommand: 'curl -fsSL https://jawji.space/companion/pi-autonomy.sh | bash',
    features: ['MAVSDK Python', 'MAVLink routing', 'Mission script examples', 'Geofence integration', 'Jawji Agent', 'Auto-start on boot'],
  ...
  // ── Jetson Templates ─────────────────────────────────────────
  {
    ...
    category: 'Autonomy',
    flashMethod: 'script',
    installCommand: 'curl -fsSL https://jawji.space/companion/jetson-cv.sh | bash',
    features: ['YOLO object detection (GPU)', 'MAVSDK integration', 'MAVLink routing', 'Camera pipeline', 'Jawji Agent', 'ROS2 optional'],
