 ...
 *
 * Features:
 * - Parses `dump` output for current config
 * - PID/Rates/Mixer/Servo/Modes tabs
 * - Sends CLI commands to apply changes
 * - Save command persists to EEPROM
 */
...
export default function LegacyConfigView() {
  ...
  const { isLoading, error, loadConfig, hasChanges, saveChanges, pid } = useLegacyConfigStore();
    ...
    <div className="h-full flex flex-col bg-zinc-950">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {isLoading ? 'Saving...' : 'Save to EEPROM'}
          </button>
        </div>
      </div>
