...
- *Status:* the package is built, tested (16 unit tests, all passing), and published with CI green. Not yet wired into Jawji desktop or Jawji Controller — tracked as a follow-up in the Roadmap.
...
**A real crash bug found and fixed in Jawji Controller**, while verifying the installer end to end.
