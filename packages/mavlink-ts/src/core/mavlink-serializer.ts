...
/**
 * Serialize a MAVLink v2 packet (async version)
 * Delegates to serializeV2 — kept for backwards compatibility.
 * Both versions now produce identical valid SHA256 signatures.
 */
export async function serializeV2Async(
  ...
  return serializeV2(msgid, payload, crcExtra, options);
}
