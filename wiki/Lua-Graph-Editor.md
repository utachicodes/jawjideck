...
Graphs are saved as `.adgraph` JSON files containing the full node layout, connections, properties, and viewport position. You can share `.adgraph` files with other Jawji users.
